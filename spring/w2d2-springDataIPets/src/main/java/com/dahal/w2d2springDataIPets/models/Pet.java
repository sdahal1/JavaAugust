package com.dahal.w2d2springDataIPets.models;
...
public class Pet {
    ...
    //telling Java to automatically generate the time stamps for the createdAt and UpdatedAt
    @PrePersist
    ...
    //empty constructor and a loaded constructor
    public Pet() {
    }
